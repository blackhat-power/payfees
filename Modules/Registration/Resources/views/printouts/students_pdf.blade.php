...
<table class="table1" style="width:100%; margin-top: 10px" border="1">
    <thead>
        <tr>
            <th>SN</th>
            <th style="text-align: left;font-size: 12px">Photo</th>
            <th style="text-align: left;font-size: 12px">Full Name</th>
            <th style="text-align: left;font-size: 12px">Class</th>
            <th style="text-align: left;font-size: 12px">Stream</th>
            <th style="text-align: left;font-size: 12px">Date Of Birth</th>
