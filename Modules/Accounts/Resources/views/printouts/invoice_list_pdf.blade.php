...
<table class="table1" style="width:100%; margin-top: 10px" border="1">
    <thead>
        <tr>
            ...
            <th style="text-align: left;font-size: 12px">Invoice No.</th>
            <th style="text-align: left;font-size: 12px">Student</th>
            <th style="text-align: left;font-size: 12px">Amount Billed</th>
            <th style="text-align: left;font-size: 12px">Amount Paid</th>
            <th style="text-align: left;font-size: 12px">Balance</th>
    ...
    <tbody>
        ...
        <tr>
            <td>{{ ++$index }}</td>
            <td> {{   date("M jS, Y", strtotime("".$invoice->date.""))  }} </td>
            <td>{{ $invoice->invoice_number }}</td>
            <td> 
                {{  App\Models\Account::find($invoice->account_id)->students[0]->full_name;      }}
            </td>
            <td> 
