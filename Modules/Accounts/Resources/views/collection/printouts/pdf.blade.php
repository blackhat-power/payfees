...
<p style="text-align: center; color: #2B336F; font-size:13px !important"> <b>STUDENTS COLLECTION LIST</b>  </p>
...
<table class="table1" style="width:100%; margin-top: 10px" border="1">
    ...
    <tfoot>
        <tr style="background-color: #AEAAAA">
            ...
            <th style="text-align: right">{{ number_format($total_collection) }}</th>
        </tr>
