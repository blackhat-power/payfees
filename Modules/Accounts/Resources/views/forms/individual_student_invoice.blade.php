                                        ...
                                        <div class="row">
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" value="{{$season_name}}" disabled>
                                                    <input type="hidden" name="academic_season" class="form-control form-control-sm" value="{{$season_id}}">
                                                 </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
...
$.ajax({
    ...
    success: function (response) {
        if(response.state == 'Done'){
            window.location.replace('{{route('accounts.invoices.individual.view',$std_id) }}');
