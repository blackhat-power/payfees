...
@section('content-heading')
          ...
          <nav aria-label="breadcrumb" style="width: 100%">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Receipts Voucher</a></li>
...
<div class="card" style="width: 100%" >
    ...
    <div class="card-header border-bottom">
        ...
        <span class="float-right">
            ...
            <a href="{{ route('accounts.receipts.voucher.form') }}" title="new contra voucher"  id="register" type="button" class=" btn btn-primary btn-sm" ><i class="fa fa-plus-circle"></i>&nbsp;New Receipt Voucher</a>
        </span>
        <form id="filter_form">
    ...
    <div class="card-body">
         <div class="table-responsive "> 
            <table id="receipts_voucher_table" class="table table-striped table-bordered table-sm" width="100%" style="table-layout: inherit">
                <thead>
                <tr>
                    <th>Date</th>
