...
<!-- </span> -->
       <div class="container">
        <span id="invoice_span">Journal Voucher</span>
    ...
    <table class="description" style="width:94%;">
        ...
        <tfoot>
            ...
            <tr> 
                <th colspan="2"> </th> 
                <th style="text-align:right;padding:8px;"> {{  number_format($journal_entry->journal_entries_amount)  }}</th> 
                <th style="text-align:right;padding:8px;"> {{ number_format($journal_entry->journal_entries_amount)   }} </th> 
    ...
    <table  style="width:94%;margin-top:5%">
        <thead>
               <tr>
                <th style="text-align: left; color:#040965; padding-bottom:10px;"> Amount In Words: </th>
               </tr>
               <tr>
                <td colspan="15" style="width:100%; padding:5px;"><p style="margin-top:-18px;">  {{  Helper::inwords($journal_entry->journal_entries_amount )    }} Only </p></td>
            </tr>

        </thead>            
    </table>

    <table  style="width:94%;margin-top:-1%">
        <thead>
               <tr>
                <th style="text-align: left; color:#040965; padding-bottom:10px;"> Description: </th>
               </tr>
               <tr>
                <td colspan="15" style="width:100%; padding:5px;"><p style="margin-top:-18px;"> {{ ucwords( $journal_entry->remarks )   }} </p></td>
            </tr>
