...
<!-- </span> -->
       <div class="container">
        <span id="invoice_span">Payment Voucher</span>
    ...
    <table class="description" style="width:94%;">
        ...
        <tbody>
            <tr>
                <td style="text-align: left; color:black !important"> {{ ucwords($journal_entry_items->account_name) }} </td>
                <td>  {{ ucwords($journal_entry->remarks) }} </td>
                <td style="text-align: right; padding:8px;"> {{ number_format($journal_entry_items->amount)   }}  </td>
            </tr>
        </tbody>
        ...
        <tfoot>
            ...
            <tr> 
                <th colspan="2"> </th> 
                <th style="text-align:right;padding:8px;"> {{ number_format($journal_entry_items->amount)   }} </th> 
            </tr>
        </tfoot>
    ...
    <table  style="width:94%;margin-top:5%">
        <thead>
               ...
               <tr>
                <td colspan="15" style="width:100%; padding:5px;"><p style="margin-top:-18px;">  {{  Helper::inwords($journal_entry_items->amount )}} Only </p></td>
            </tr>
