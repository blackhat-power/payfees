...
<p style="text-align:center"> <b>ACCOUNT SUB GROUPS LIST </b>  </p>
<table class="table1" style="width:100%; margin-top: 10px" border="1">
    ...
    <tbody>
        @foreach ($account_sub_groups  as $index  =>  $account_sub_group)  
        <tr>
            <td>{{ ++$index }}</td>
            <td> {{ $account_sub_group->sub_group_name  }} </td>
            <td>{{ $account_sub_group->group_name }}</td>
