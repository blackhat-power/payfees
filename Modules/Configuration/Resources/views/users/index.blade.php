...
<div class="card" style="width: 100%" >
    {{--  <div class="card-header d-flex justify-content-between">
     ...
     <div class="card-header border-bottom">
             ...
             <a href="{{ route('configuration.users.create') }}" id="register" type="button" class=" btn btn-sm btn-primary float-right" style="color: white"><i class="fa fa-plus-circle"></i> New User </a>
