...
<div class="container-fluid">
      ...
      @include('configuration::school.includes.school_profile')
       <div class="col-lg-9 col-md-6">
          <div class="card card-block card-stretch card-height">
             ...
             <h6 style="text-align: center"> List of Streams </h6>
 ...
 let class_url = '{{ route('configurations.school.classes.profile.datatable',':id') }}';
 
 class_url = class_url.replace(':id',  @php echo $class_id @endphp)
