           ...
           <div class="card card-block card-stretch card-height">
              ...
              {{-- @include('configuration::school.includes.tabs') --}}
                               ...
                               <div class="row">
                                  <div class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="" name="season_name[]" >
                                        <input type="hidden" name="hidden_season_id" value="">
                                     </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="form-group form-group-sm">
                                     ...
                                     <input type="date" class="form-control form-control-sm" value="" name="season_start_date[]" >
                                  ...
                                  <div class="col-md-4">
                                     <div class="form-group form-group-sm">
                                        ...
                                        <input type="date" class="form-control form-control-sm" value="" name="season_end_date[]" >
                                     </div>
                                 </div>
                               </div>
                            </div>
                               ...
                               <div class="row">
                                  <div class="col-md-4">
                                     <div class="form-group form-group-sm">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="" name="semester_name[]" >
                                        <input type="hidden" name="hidden_semester_id[]" value="">
                                     </div>
                      ...
                      <div id="classes_row">
                                  ...
                                  <div class="row">
                                     <div class="col-md-4">
                                        <div class="form-group form-group-sm" style="margin-left: 12px">
                                           ...
                                           <input type="text" value="" name="class_name[]" class="form-control form-control-sm" >
                              ...
                              <div class="col-md-3">
                               <div class="form-group form-group-sm">
                                  ...
                                  <select class="multiple_select form-control" multiple name="streams[0][]" style="width: 100%">
                 ...
                 <div class="row justify-content-md-end" style="margin-right:4%">
                   <div class="form-group">
                      <button type="button" style="margin-top:2%" class="btn btn-primary btn-sm float-right" id="save_seasons_n_classes"> <i class="fa fa-paper-plane"></i> Save</button>
                   </div>
 ...
 removeClass();
  ...
  $('#save_seasons_n_classes').click(function(e){
     ...
     let url = '{{route('school.settings.seasons.store',':id')}}';
