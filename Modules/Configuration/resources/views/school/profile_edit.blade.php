...
@section('content-heading')
          ...
          <nav aria-label="breadcrumb" style="width: 100%">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Swefwrystem Settings</a></li>
            </ol>
          </nav>
                             ...
                             {{--  <input type="file" name="photo" onchange="previewFile(this)" class="custom-file-input" data-show-caption="false" data-show-upload="false" data-fouc required>
                              ...
                              <div class="custom-file">
                                 <span>
                                    ...
                                    <input type="file" value="{{ $url }}" name="logo" onchange="previewFile(this)" class="custom-file-input form-control-sm" id="customInput">
                                 </span>
                             </div>
                           </div>
                        </div>
